  ...
  if (isUserError) {
    return (
      <>
        ...
        <Layout>
          <ErrorFallback message="Este usuario no existe" />
        </Layout>
      </>
    );
  }
    ...
    <>
      ...
      <Layout>
        ...
        {(section === "followers" || section === "following") && (
          <ModalWrapper title="Seguidores" handleCloseModal={closeModal}>
            <UserFollows section={section} userId={userId} />
          </ModalWrapper>
        )}
        {section === "settings" && (
          <ModalWrapper title="Ajustes" handleCloseModal={closeModal}>
